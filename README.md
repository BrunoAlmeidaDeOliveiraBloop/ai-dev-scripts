...
> 🇧🇷 Este repositório centraliza prompts e scripts de linguagem natural para otimizar o uso do GitHub Copilot e outras IAs generativas no fluxo de desenvolvimento.
>
> 🇺🇸 This repository centralizes prompts and natural language scripts to optimize GitHub Copilot and other generative AIs within the development workflow.

---

## 🧩 Modos do Copiloto / Copilot Modes

Inspirado na metodologia da **DIO**, este projeto organiza os prompts de acordo com o modo de interação desejado:
...
2.  Referencie o prompt desejado (ex: `@workspace /explain #file:ask.md`).
3.  Siga o guia específico de cada arquivo para obter resultados padronizados.
